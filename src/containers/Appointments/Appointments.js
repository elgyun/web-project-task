...
class Appointments extends Component {
  ...
  render() {
    ...
    const { isFetching, dataSource: ds, directory } = this.props;

    const { startDate, endDate, clientName, statusId, onlyMe } = ds.filter;
        ...
        <div className="Appointments-Body">
          <div className="Appointments-Filter">
            ...
            <Form className="Appointments-FilterForm">
              ...
              >
                <Reset className="Appointments-SearchBtnIcon" />
              </Button>
